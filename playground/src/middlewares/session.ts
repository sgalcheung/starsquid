...
import {
  getIntroductionBySlug,
  type IntroductionCollectionType,
  type IntroductionDtoType,
} from "../data/models/Introduction";

export const loadCatalogFromSession: MiddlewareHandler = async (
  context,
  next
) => {
